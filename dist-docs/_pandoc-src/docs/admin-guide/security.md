...
::: {.tip data-title="Warum braucht man `<db>.integrity.dbkey.json`, obwohl der Root‑Public‑Key in der App steckt?"}
...
::: {.tip data-title="Hinweis (warum TSA weiterhin SHA‑256 nutzt)"}
