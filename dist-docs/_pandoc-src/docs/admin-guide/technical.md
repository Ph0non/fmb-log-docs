...
::: {.info data-title="Zusammenfassung (Speicherorte)"}
...
::: {.tip data-title="Stub‑DB aktualisieren (bei Schema‑Änderungen)"}
...
::: {.info data-title="Zusammenfassung (Protokolle)"}
...
::: {.info data-title="Zusammenfassung (CR‑SQLite)"}
...
::: {.info data-title="Zusammenfassung (Auth)"}
...
::: {.info data-title="Zusammenfassung (Signaturen)"}
...
::: {.info data-title="Zusammenfassung (Hashes)"}
...
::: {.info data-title="Zusammenfassung (Tagesabrechnung)"}
...
::: {.info data-title="Zusammenfassung (Audit)"}
